...
owner_ID = localStorage.getItem('current_user')[0]
...
function send_to_server(){
    ...
    console.log("dakhalt el async");
		const rawResponse = await fetch('http://10.28.143.233:8080/savelist', {
			method: 'POST',
			headers: {
  ...
  update_saturday();
	...
	xhr.open("POST", 'http://10.28.143.233:8080/savelist', true);
...
function getSaturdayReq(dayString){
  saturdaysFetched=[];
  (async () => {
		const rawResponse = await fetch('http://10.28.143.233:8080/getSaturdayRequirements', {
			method: 'GET',
			headers: {
				'Accept': 'application/json',
				'Content-Type': 'application/json'
...
function getPTOReq(dayString){
  saturdaysFetched=[];
  (async () => {
		const rawResponse = await fetch('http://10.28.143.233:8080/getPTOReq', {
			method: 'GET',
			headers: {
				'Accept': 'application/json',
				'Content-Type': 'application/json'
...
// 		const rawResponse = await fetch('http://10.28.143.233:8080/savesat', {
// 			method: 'POST',
// 			headers: {
// 				'Accept': 'application/json',
// 				'Content-Type': 'application/json'
